...
for i = start : fin
  ...
  poolID = genvarname(COLLECTIONS.identifiers.pool(collectionID));
   ...
   save(COLLECTIONS.path.pool(collectionID), COLLECTIONS.identifiers.pool(collectionID));
  ...
  runsetID = genvarname(COLLECTION.(collectionID).runSetId);
   ...
   %save the runSet 
  save(COLLECTIONS.path.runSet(collectionID),COLLECTION.(collectionID).runSetId);
